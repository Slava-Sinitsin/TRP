...
import com.example.trp.navigation.graphs.teacher.TeacherWelcomeNavGraph
...
fun TeacherWelcomeScreen(navController: NavHostController = rememberNavController()) {
    val viewModel = viewModel<TeacherWelcomeScreenViewModel>(
        factory = object : ViewModelProvider.Factory {
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                return TeacherWelcomeScreenViewModel(navController) as T
            }
        }
    )
